...
const NAV_ITEMS = {
    admin: [
      ...
      { label: 'Moments That Matter', href: '/dashboard/admin/moments', icon: '🎂' },
    ...
    hr: [
      ...
      { label: 'Moments That Matter', href: '/dashboard/hr/moments', icon: '🎂' },
    ...
    employee: [
      ...
      { label: 'Moments That Matter', href: '/dashboard/employee/moments', icon: '🎂' },
