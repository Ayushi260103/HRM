      ...
      <main className="flex-1 pt-14 px-4 pb-4 sm:pt-6 sm:px-5 sm:pb-5 md:pt-6 md:px-6 md:pb-6 lg:pt-8 lg:px-8 lg:pb-8 lg:ml-64 min-w-0">
        <div className="w-full max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Link href="/dashboard/hr/leaves/leave-requests" className="block group">
            ...
            <Link href="/dashboard/hr/leaves/leave-allocation" className="block group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all">
                <div className="text-3xl mb-3">🧮</div>
                <h3 className="font-semibold text-gray-900 text-lg group-hover:text-blue-600 transition">
                  Leave Allocation
            ...
            <Link href="/dashboard/hr/leaves/holiday-allocation" className="block group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all">
                <div className="text-3xl mb-3">📅</div>
                <h3 className="font-semibold text-gray-900 text-lg group-hover:text-blue-600 transition">
                  Holiday Allocation
            ...
            <Link href="/dashboard/hr/leaves/weekend-allocation" className="block group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all">
                <div className="text-3xl mb-3">🗓️</div>
                <h3 className="font-semibold text-gray-900 text-lg group-hover:text-blue-600 transition">
                  Weekend Allocation
                </h3>
                <p className="text-sm text-gray-600 mt-2">Set weekend days for employees</p>
              </div>
            </Link>

            <Link href="/dashboard/hr/leaves/leave-apply" className="block group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all">
                <div className="text-3xl mb-3">✏️</div>
                <h3 className="font-semibold text-gray-900 text-lg group-hover:text-blue-600 transition">
                  Leave Apply
                </h3>
                <p className="text-sm text-gray-600 mt-2">Apply and track your own leaves</p>
              </div>
            </Link>
          </div>
        </div>
