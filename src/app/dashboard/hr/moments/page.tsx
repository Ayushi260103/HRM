...
export default function HRMomentsPage() {
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 p-4 sm:p-5 md:p-6 lg:p-8 lg:ml-64 min-w-0">
        <div className="w-full max-w-4xl mx-auto">
          ...
          <Link href="/dashboard/hr/moments/office-holidays" className="mb-6 block">
          ...
          <Link href="/dashboard/hr/upcoming-birthdays" className="block">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all">
              <div className="flex items-center gap-4">
                <span className="text-3xl">🎂</span>
                <div>
